...
def main_street(items):
    ...
    print_pause("\nEnter 1 to enter the stable.")
    print_pause("Enter 2 to enter the saloon.")
    print_pause("Enter 3 to enter the gun shop.")
    print("What will you do?")
    ...
    if response == "1":
        ...
        print_pause("You can't enter the gun shop while "
                    "riding a horse.")
        print_pause("You turn around and go back to the main "
                    "street.")
        main_street(items)
    elif response == "3" and "horse" not in items:
        print_pause("You enter the gun shop.")
        gun_shop(items)
    else:
        print_pause("Please enter a valid number")
        main_street(items)
